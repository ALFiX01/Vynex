...
Для `TUN` при запуске из исходников используйте PowerShell от имени администратора и команду `python main.py`. Сам `main.py` через контекстное меню проводника Windows поднимать не стоит.
